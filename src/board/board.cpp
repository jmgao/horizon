...
void Board::expand(bool careful)
{
    ...
    for (auto &it : vias) {
        ...
        ps_via.emplace(BuiltinParameter::VIA_SOLDER_MASK_EXPANSION, params->via_solder_mask_expansion);
    ...
    for (auto &it : holes) {
        ...
        ps_hole.emplace(BuiltinParameter::HOLE_SOLDER_MASK_EXPANSION, params->hole_solder_mask_expansion);
...
void Board::expand_packages()
{
    auto params = rules.get_parameters();
    ParameterSet pset = {
            {BuiltinParameter::COURTYARD_EXPANSION, params->courtyard_expansion},
            {BuiltinParameter::PASTE_MASK_CONTRACTION, params->paste_mask_contraction},
            {BuiltinParameter::SOLDER_MASK_EXPANSION, params->solder_mask_expansion},
            {BuiltinParameter::HOLE_SOLDER_MASK_EXPANSION, params->hole_solder_mask_expansion},
